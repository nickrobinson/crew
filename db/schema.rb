...
ActiveRecord::Schema[8.1].define(version: 2026_01_26_172650) do
  create_table "contributions", force: :cascade do |t|
    ...
    t.index ["developer_id", "repository_id"], name: "index_contributions_on_developer_id_and_repository_id", unique: true
    t.index ["developer_id"], name: "index_contributions_on_developer_id"
